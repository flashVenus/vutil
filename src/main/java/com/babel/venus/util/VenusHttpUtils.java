...
public class VenusHttpUtils {
    ...
    protected static final Logger log = LoggerFactory.getLogger(VenusHttpUtils.class);
    ...
    public static ResponseData execRequest(String serverUrl, SendReq req, Object[] args, Object[] argHeaders) {
    ...
    public static ResponseData execRequest(String serverUrl, SendReq req, Object[] args) {
        Map<String, Object> params = convertParams(req.params, args);
        ResponseData result;
        String url = serverUrl + req.url;
        try {
    ...
    public static ResponseData execRequest(String serverUrl, SendReq req, String paramStr, Object[] argHeaders) {
        Map<String, Object> headers = convertParams(req.headers, argHeaders);
